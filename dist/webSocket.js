...
let currentStartingLoadoutEquipment = [];
// 現在のオブザーバー情報を保持する変数
let currentObserverState = {};
...
export async function main(server) {
    ...
    const types = {
        "type.googleapis.com/rtech.liveapi.Init": root.lookupType("rtech.liveapi.Init"),
        "type.googleapis.com/rtech.liveapi.CustomMatch_LobbyPlayers": root.lookupType("rtech.liveapi.CustomMatch_LobbyPlayers"),
        "type.googleapis.com/rtech.liveapi.CustomMatch_LegendBanStatus": root.lookupType("rtech.liveapi.CustomMatch_LegendBanStatus"),
        "type.googleapis.com/rtech.liveapi.PlayerConnected": root.lookupType("rtech.liveapi.PlayerConnected"),
        "type.googleapis.com/rtech.liveapi.PlayerDisconnected": root.lookupType("rtech.liveapi.PlayerDisconnected"),
        "type.googleapis.com/rtech.liveapi.GameStateChanged": root.lookupType("rtech.liveapi.GameStateChanged"),
        "type.googleapis.com/rtech.liveapi.MatchSetup": root.lookupType("rtech.liveapi.MatchSetup"),
        "type.googleapis.com/rtech.liveapi.MatchStateEnd": root.lookupType("rtech.liveapi.MatchStateEnd"),
        "type.googleapis.com/rtech.liveapi.RingStartClosing": root.lookupType("rtech.liveapi.RingStartClosing"),
        "type.googleapis.com/rtech.liveapi.RingFinishedClosing": root.lookupType("rtech.liveapi.RingFinishedClosing"),
        "type.googleapis.com/rtech.liveapi.ObserverSwitched": root.lookupType("rtech.liveapi.ObserverSwitched"),
        "type.googleapis.com/rtech.liveapi.ObserverAnnotation": root.lookupType("rtech.liveapi.ObserverAnnotation"),
        "type.googleapis.com/rtech.liveapi.WeaponSwitched": root.lookupType("rtech.liveapi.WeaponSwitched"),
        "type.googleapis.com/rtech.liveapi.InventoryPickUp": root.lookupType("rtech.liveapi.InventoryPickUp"),
        "type.googleapis.com/rtech.liveapi.InventoryDrop": root.lookupType("rtech.liveapi.InventoryDrop"),
        "type.googleapis.com/rtech.liveapi.InventoryUse": root.lookupType("rtech.liveapi.InventoryUse"),
        "type.googleapis.com/rtech.liveapi.PlayerDamaged": root.lookupType("rtech.liveapi.PlayerDamaged"),
        "type.googleapis.com/rtech.liveapi.PlayerKilled": root.lookupType("rtech.liveapi.PlayerKilled"),
        "type.googleapis.com/rtech.liveapi.PlayerDowned": root.lookupType("rtech.liveapi.PlayerDowned"),
        "type.googleapis.com/rtech.liveapi.PlayerAssist": root.lookupType("rtech.liveapi.PlayerAssist"),
        "type.googleapis.com/rtech.liveapi.SquadEliminated": root.lookupType("rtech.liveapi.SquadEliminated"),
        "type.googleapis.com/rtech.liveapi.PlayerStatChanged": root.lookupType("rtech.liveapi.PlayerStatChanged"),
        "type.googleapis.com/rtech.liveapi.PlayerRespawnTeam": root.lookupType("rtech.liveapi.PlayerRespawnTeam"),
        "type.googleapis.com/rtech.liveapi.PlayerRevive": root.lookupType("rtech.liveapi.PlayerRevive"),
        "type.googleapis.com/rtech.liveapi.AmmoUsed": root.lookupType("rtech.liveapi.AmmoUsed"),
        "type.googleapis.com/rtech.liveapi.CharacterSelected": root.lookupType("rtech.liveapi.CharacterSelected"),
        "type.googleapis.com/rtech.liveapi.ZiplineUsed": root.lookupType("rtech.liveapi.ZiplineUsed"),
        "type.googleapis.com/rtech.liveapi.PlayerUltimateCharged": root.lookupType("rtech.liveapi.PlayerUltimateCharged"),
        "type.googleapis.com/rtech.liveapi.PlayerAbilityUsed": root.lookupType("rtech.liveapi.PlayerAbilityUsed"),
        "type.googleapis.com/rtech.liveapi.PlayerUpgradeTierChanged": root.lookupType("rtech.liveapi.PlayerUpgradeTierChanged"),
        "type.googleapis.com/rtech.liveapi.LegendUpgradeSelected": root.lookupType("rtech.liveapi.LegendUpgradeSelected"),
        "type.googleapis.com/rtech.liveapi.GrenadeThrown": root.lookupType("rtech.liveapi.GrenadeThrown"),
        "type.googleapis.com/rtech.liveapi.GibraltarShieldAbsorbed": root.lookupType("rtech.liveapi.GibraltarShieldAbsorbed"),
        "type.googleapis.com/rtech.liveapi.RevenantForgedShadowDamaged": root.lookupType("rtech.liveapi.RevenantForgedShadowDamaged"),
        "type.googleapis.com/rtech.liveapi.ArenasItemSelected": root.lookupType("rtech.liveapi.ArenasItemSelected"),
        "type.googleapis.com/rtech.liveapi.ArenasItemDeselected": root.lookupType("rtech.liveapi.ArenasItemDeselected"),
        "type.googleapis.com/rtech.liveapi.BannerCollected": root.lookupType("rtech.liveapi.BannerCollected"),
        "type.googleapis.com/rtech.liveapi.BlackMarketAction": root.lookupType("rtech.liveapi.BlackMarketAction"),
        "type.googleapis.com/rtech.liveapi.WraithPortal": root.lookupType("rtech.liveapi.WraithPortal"),
        "type.googleapis.com/rtech.liveapi.WarpGateUsed": root.lookupType("rtech.liveapi.WarpGateUsed"),
        "type.googleapis.com/rtech.liveapi.PauseStateChangeNotification": root.lookupType("rtech.liveapi.PauseStateChangeNotification"),
        "type.googleapis.com/rtech.liveapi.Response": root.lookupType("rtech.liveapi.Response"),
    };
    ...
    wss.on("connection", (ws, req) => {
        ...
        ws.on("message", (message) => {
            if (!(message instanceof Buffer))
                return;
            try {
                const event = LiveAPIEvent.decode(message);
                const anyMessage = Any.decode(event["gameMessage"]);
...
function updatePlayers(message) {
    ...
    // プレイヤー状態を自動判定する関数
    function autoUpdatePlayerState(playerObj) {
        if (!playerObj)
            return;
        ...
        if (typeof playerObj.currentHealth === "number" &&
    ...
    switch (category) {
        ...
        case "playerRespawnTeam":
            ...
            if (message.respawnedTeammates &&
                Array.isArray(message.respawnedTeammates)) {
                message.respawnedTeammates.forEach((respawnedPlayer) => {
        ...
        case "playerDamaged":
            ...
            if (message.attacker &&
                ...
                if (!players[attackerName].stats)
                    players[attackerName].stats = {};
            ...
            if (message.victim && message.victim.name) {
                ...
                const oldHealth = players[victimName].currentHealth ?? message.victim.currentHealth;
                const oldShield = players[victimName].shieldHealth ?? message.victim.shieldHealth;
                ...
                if (!players[victimName].stats)
                    players[victimName].stats = {};
        ...
        case "playerKilled":
            ...
            if (message.awardedTo &&
                ...
                // awardedToのキル統計を加算
                if (!players[awardedToName].stats)
                    players[awardedToName].stats = {};
            ...
            if (playerName &&
                ...
                if (survivalItems.includes(pickedUpItemBaseName)) {
                    ...
                    Object.keys(players[playerName].inventory).forEach((key) => {
                        ...
                        if (survivalItems.includes(existingItemBaseName) &&
                ...
                const currentQuantity = players[playerName].inventory[message.item] || 0;
        ...
        case "inventoryDrop":
            if (playerName &&
                ...
                if (players[playerName].inventory &&
                    ...
                    const higherLevelItemExists = Object.keys(players[playerName].inventory).some((key) => key.startsWith(itemBaseName) &&
                        key !== message.item &&
                        /\(Level \d+\)$/.test(key));
            ...
            if (playerName &&
                ...
                if (players[playerName].inventory) {
                    for (const itemKey in players[playerName].inventory) {
                        ...
                        if (players[playerName].inventory[itemKey] === message.oldAmmoCount) {
                            // 弾薬っぽい名前かどうかで絞り込む（簡易的なチェック）
                            if (itemKey.includes("Rounds") ||
                ...
                if (foundItemKey) {
                    ...
                    console.warn(`⚠️ ${playerName} のインベントリで oldAmmoCount ${message.oldAmmoCount} に一致する弾薬アイテムが見つかりませんでした。ammoType: ${message.ammoType}`);
        ...
        case "matchSetup":
            ...
            if (message.startingLoadout &&
                Array.isArray(message.startingLoadout.equipment)) {
                // シールドバッテリーを除外して保存
                currentStartingLoadoutEquipment =
                    message.startingLoadout.equipment.filter((item) => item.item !== "Shield Battery");
        ...
        case "gameStateChanged":
            if (message.state === "WaitingForPlayers" ||
                message.state === "Resolution") {
                // "Resolution"状態を追加
                // 新しいゲームが始まる際、またはゲーム終了時にプレイヤーリストをクリア
                console.log(`ゲーム状態が${message.state}になりました。プレイヤーリストをクリアします。`);
